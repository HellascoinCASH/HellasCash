...
uint256 hashGenesisBlock("0xe00b3125fcbddb26a7611a75b2f031a427ecfa1127208578ee2c577df22dae1b");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(521093680); // HellasCASH: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "HellasCASH Signed Message:\n";
...
{
    // HellasCASH: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 84000000); // HellasCASH: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 999999; // HellasCASH: 3.5 days
static const int64 nTargetSpacing = 300; // HellasCASH: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // HellasCASH: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // HellasCASH: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // HellasCASH: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcbf3687ad6777bf714f527df185b6b56dceb57bb7f6f70ebe76594660efc1fea");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "New complaints from the KKE about strange encounters";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("00051f5a6992359abdbe7ab6019a32dfc386e030f7740dfe188623c2521a0e782d41eeee0bee51ad3cfb84e09a7fe3807454a526aa79cb166cb394f3b326ba6b52") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1517305284;
        block.nBits    = 521093680;
        block.nNonce   = 3424577073;

        if (fTestNet)
        {
            block.nTime    = 1517305284;
            block.nNonce   = 163607130;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1ae5b65f6b22bed79977e1abc92fdb035306404613c0e1eff6f9c0e9c8938154"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // HellasCASH: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("HellasCASHMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("HellasCASHMiner : ProcessBlock, block not accepted");
    }
